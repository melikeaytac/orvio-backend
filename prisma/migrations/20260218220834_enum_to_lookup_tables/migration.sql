...
-- ========================================
-- STEP 0: Drop existing lookup tables if they exist (for idempotency)
-- ========================================

DROP TABLE IF EXISTS "DisputeReasonLookup" CASCADE;
DROP TABLE IF EXISTS "AccessReasonLookup" CASCADE;
DROP TABLE IF EXISTS "ActionTypeLookup" CASCADE;
DROP TABLE IF EXISTS "TransactionStatusLookup" CASCADE;
DROP TABLE IF EXISTS "AlertStatusLookup" CASCADE;
DROP TABLE IF EXISTS "DeviceStatusLookup" CASCADE;
